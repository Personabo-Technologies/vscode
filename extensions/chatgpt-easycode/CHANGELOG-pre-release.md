...
- Fixed CMD + D tutorial bug on windows
- Fixed and improved CMD + D streaming

## [2.1.9]

- Bug fix for ask codebase
- Observability improvements

## [2.1.8]

- Cmd + d improvements, bug fixes, and UX changes
- Added cmd + d tutorial
- Opened pre-release to all
- Removed shared context
...
- Bug fix for socket hangup and chat, and shared context

## [2.1.3]

- Bug fixes for shared context, cmd + d, and autocomplete

## [2.1.2]

- changed diff with gpt to use chat window
- added the ability to '@' files in command d and as part of autocomplete comments
- added a add to context command that allows adding specific code selections to the context in the chat

## [2.1.1]

- Fixed a bug of accidentally reverting shared context
...
- Added a new "Diff with GPT" feature
  ...
  - Shared context will be used when this feature is turned on
- Added a new shared context feature
  - To enable shared context, click the checkbox on the top left of the chat window
  - Shared context allows you to maintain context across multiple sessions, which can be used within chat, autocomplete, and "diff with gpt"
- Added claude-3.5-sonnet as a model option
...
- Added a new Apply button to code blocks in chats that will apply the given code to the relevant file in a merge state
  - Feature is only shown when using gpt-4o and @ or ask codebase
